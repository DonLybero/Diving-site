 ...
 * @property {(bytes: Uint8Array, text: string, options?: Object) => ParseResult|Promise<ParseResult>} parse
 *   never throws; may be async (the pipeline awaits) — e.g. FIT lazy-loads its reader
 */
