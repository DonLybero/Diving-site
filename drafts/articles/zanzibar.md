# Zanzibar dive trip: two peak seasons, one plan that uses them

The headline finding on a Zanzibar dive trip is that there is no single best season — there are two, and they are different trips. January to March is the warm one: the kaskazi monsoon settles the sea flat, water hits 28-29°C, visibility peaks around 25 m, whale sharks pass offshore and February adds reef-fish spawning aggregations. September to October is the cool one: visibility is the same 25 m, but the water drops to 25-26°C and the pelagic odds improve — humpback whales gather in numbers in September, and October overlaps the last humpbacks with the first whale sharks of the new season. Pick the window first, then build the days around it.
...
So the split works like this. **Two Stone Town nights** at the start cover the heritage walk, an evening at Forodhani and a half-day boat to Prison Island — the town's best hours are the ones day-trippers miss, and one night forces a choice between them. **Five dive days** is the number the site list actually supports: at two dives a day that is ten dives across six named sites — three at Mnemba (Kichwani, Wattabomi, Big Wall), two northern reefs (Hunga Reef, Tumbatu Coral Gardens) and a Leven Bank day once a few local drifts are logged — with room to repeat the Mnemba slope that earns it. Four dive days forces a choice between Mnemba and the north; six or more and you are re-diving without new ground. **The final day is the no-fly day**, and ending it near Stone Town solves it: dive your last morning up north, transfer down in the afternoon, then spend the off-gassing day at a spice farm or Jozani Forest before an evening at the night market. Nine days, none of them a waiting day.

Shorter version if you must: 7 days with 1 Stone Town night, 4 dive days and the no-fly day — but that drops Leven Bank or a Mnemba repeat, and Stone Town becomes a sprint.

## Pick your coast

Where you sleep shapes the trip, because Zanzibar's coasts differ sharply.

**Nungwi and Kendwa**, at the northern tip, are the default dive base: the only coast where the sea stays swimmable at all tides, the island's densest cluster of dive centres, and the widest site menu — boats reach Mnemba, Hunga Reef, the Tumbatu gardens and Leven Bank from here. Kendwa adds monthly full-moon beach parties if that is your speed.
...
Off the north coast, **Hunga Reef** (10-17 m) is a circular open-water reef known for huge coral bommies and consistently sharp visibility, and **Tumbatu Coral Gardens** (8-20 m) holds the island's healthiest coral, with seahorses and turtles among the highlights.
...
Open the Trip Planner tab and pull up Zanzibar: month-by-month ratings and water temperatures, all six sites with depths and levels, plus the transfers, stays and events in one place. Pick your window — January-March warm or September-October wild — and build the nine days around it.
